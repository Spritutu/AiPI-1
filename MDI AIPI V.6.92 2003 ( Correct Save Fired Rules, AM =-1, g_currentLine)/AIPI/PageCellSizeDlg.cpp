...
void CPageCellSizeDlg::OnChkRowResize() 
{
	...
	if( pMainFrame->m_bRowResize == 0)
	{
		...
		{
		case GRID_PM:
			pMainFrame->ChangeGridVarState(_T("RowResizePM"), true);
			break;
		case GRID_WM:
	...
	else 
	{
		...
		{
		case GRID_PM:
			pMainFrame->ChangeGridVarState(_T("RowResizePM"), false);
			break;
		case GRID_WM:
...
void CPageCellSizeDlg::OnChkColumnResize() 
{
	...
	if( pMainFrame->m_bColumnResize == 0)
	{
		...
		{
		case GRID_PM:
			pMainFrame->ChangeGridVarState(_T("ColumnResizePM"), true);
			break;
		case GRID_WM:
	...
	else 
	{
		...
		{
		case GRID_PM:
			pMainFrame->ChangeGridVarState(_T("ColumnResizePM"), false);
			break;
		case GRID_WM:
...
void CPageCellSizeDlg::OnChkFitGrid() 
{
	...
	if( pMainFrame->m_bFitGrid == 0)
	{
		...
		{
		case GRID_PM:
			pMainFrame->ChangeGridVarState(_T("FitGridPM"), true);
			break;
		case GRID_WM:
	...
	else 
	{
		...
		{
		case GRID_PM:
			pMainFrame->ChangeGridVarState(_T("FitGridPM"), false);
			break;
		case GRID_WM:
