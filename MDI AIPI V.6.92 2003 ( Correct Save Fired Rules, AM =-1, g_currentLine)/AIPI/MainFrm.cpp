...
void CMainFrame::InitGridVars()
{
	...
	//CPageEditDlg
	CreateGridVarState(_T("EditablePM"),				false);
	...
	//CPageFileDlg
	CreateGridVarState(_T("VirtualModePM"),				false);
	...
	CreateGridVarState(_T("CallbackPM"),				false);
	...
	//CPageOptionsDlg
	CreateGridVarState(_T("ToolTipsPM"),				true);
	...
	CreateGridVarState(_T("SortPM"),					false);
	...
	CreateGridVarState(_T("CellSelectPM"),				true);
	...
	//CPageFormatDlg
	CreateGridVarState(_T("HorizontalPM"),				true);
	...
	CreateGridVarState(_T("VerticalPM"),				true);
	...
	CreateGridVarState(_T("ItalicPM"),					false);
	...
	CreateGridVarState(_T("BoldPM"),					false);
	...
	CreateGridVarState(_T("NormalPM"),					true);
	...
	CreateGridVarState(_T("VerticalHeaderPM"),			false);
	...
	//CPageCellSizeDlg
	CreateGridVarState(_T("FitGridPM"),					false);
	...
	CreateGridVarState(_T("ColumnResizePM"),			true);
	...
	CreateGridVarState(_T("RowResizePM"),				true);
...
void CMainFrame::UpdateGridStates(int grid)
{
	...
	{
	case GRID_PM:
			m_bEditable = FindGridVarState(_T("EditablePM"));
			//m_bVirtualMode = FindGridVarState(_T("VirtualModePM"));
			//m_bCallback = FindGridVarState(_T("CallbackPM"));
		
			
		
			m_bToolTips = FindGridVarState(_T("ToolTipsPM"));	
			m_bSort = FindGridVarState(_T("SortPM"));
			m_bCellSelect = FindGridVarState(_T("CellSelectPM"));
		
			
			m_bHorizontal = FindGridVarState(_T("HorizontalPM"));
			m_bVertical = FindGridVarState(_T("VerticalPM"));
			m_bItalic = FindGridVarState(_T("ItalicPM"));
			m_bBold = FindGridVarState(_T("BoldPM"));
			m_bNormal = FindGridVarState(_T("NormalPM"));
			m_bVerticalHeader = FindGridVarState(_T("VerticalHeaderPM"));
		
			m_bFitGrid = FindGridVarState(_T("FitGridPM"));
			m_bColumnResize = FindGridVarState(_T("ColumnResizePM"));
			m_bRowResize = FindGridVarState(_T("RowResizePM"));
