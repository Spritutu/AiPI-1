...
void CPageOptionsDlg::OnChkToolTips() 
{
	...
	if( pMainFrame->m_bToolTips == 0)
	{
		...
		{
		case GRID_PM:
			pMainFrame->ChangeGridVarState(_T("ToolTipsPM"), true);
			break;
		case GRID_WM:
	...
	else 
	{
		...
		{
		case GRID_PM:
			pMainFrame->ChangeGridVarState(_T("ToolTipsPM"), false);
			break;
		case GRID_WM:
...
void CPageOptionsDlg::OnChkSort() 
{
	...
	if( pMainFrame->m_bSort == 0)
	{
		...
		{
		case GRID_PM:
			pMainFrame->ChangeGridVarState(_T("SortPM"), true);
			break;
		case GRID_WM:
	...
	else 
	{
		...
		{
		case GRID_PM:
			pMainFrame->ChangeGridVarState(_T("SortPM"), false);
			break;
		case GRID_WM:
...
void CPageOptionsDlg::OnCheckCellSelect() 
{
	...
	if( pMainFrame->m_bCellSelect == 0)
	{
		...
		{
		case GRID_PM:
			pMainFrame->ChangeGridVarState(_T("CellSelectPM"), true);
			break;
		case GRID_WM:
	...
	else 
	{
		...
		{
		case GRID_PM:
			pMainFrame->ChangeGridVarState(_T("CellSelectPM"), false);
			break;
		case GRID_WM:
