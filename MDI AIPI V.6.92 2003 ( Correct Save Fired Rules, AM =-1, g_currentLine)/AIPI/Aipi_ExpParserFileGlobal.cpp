...
CString CAipi_ExpParserFileGlobal::LiteralVarSearch(long iform, CString strToken )
{
...
double CAipi_ExpParserFileGlobal::NumericVarSearch(long iform, CString strToken)
{
...
void CAipi_ExpParserFileGlobal::translation_unit()
{
	...
	if( m_lookahead != _TEOF )
	{
		...
		{
			AfxMessageBox(_T("GET IN de DisplayCtrl"));
			int r = UNDEFINE;
