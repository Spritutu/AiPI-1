...
void CPageFormatDlg::OnChkHorizontal() 
{
	...
	if( pMainFrame->m_bHorizontal == 0)
	{
		...
		{
		case GRID_PM:
			pMainFrame->ChangeGridVarState(_T("HorizontalPM"), true);
			break;
		case GRID_WM:
	...
	else 
	{
		...
		{
		case GRID_PM:
			pMainFrame->ChangeGridVarState(_T("HorizontalPM"), false);
			break;
		case GRID_WM:
...
void CPageFormatDlg::OnRadioFixedItalic() 
{
	...
	if( pMainFrame->m_bItalic == 0)
	{
		...
		case GRID_PM:
			...
			pMainFrame->ChangeGridVarState(_T("ItalicPM"), true);
...
void CPageFormatDlg::OnRadioFixedBold() 
{
	...
	if( pMainFrame->m_bBold == 0)
	{
		...
		{
		case GRID_PM:
			pMainFrame->ChangeGridVarState(_T("BoldPM"), true);
